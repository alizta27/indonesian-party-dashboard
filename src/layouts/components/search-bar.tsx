  ...
  return (
    <>
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        <CommandInput
          placeholder="Tulis untuk mulai mencari..."
          value={searchQuery}
        ...
        <div className="flex flex-wrap text-text-primary p-2 justify-end gap-2">
          <div className="flex items-center gap-1">
            ...
            <Badge variant="info">↓</Badge>
            <Text variant="caption">untuk menavigasi</Text>
          </div>
          <div className="flex items-center gap-1">
            <Badge variant="info">↵</Badge>
            <Text variant="caption">untuk memilih</Text>
          </div>
          <div className="flex items-center gap-1">
            <Badge variant="info">ESC</Badge>
            <Text variant="caption">untuk menutup</Text>
          </div>
        </div>
      </CommandDialog>
    </>
