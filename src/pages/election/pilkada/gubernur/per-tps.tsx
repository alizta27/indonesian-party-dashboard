...
export default function PilkadaGubernurTps() {
	const [province, setProvince] = useState("11");
	const [kabupaten, setKabupaten] = useState("Kab. Contoh 1");
	...
	const chartOptions: ApexOptions = {
		...
		title: {
			text: `Perolehan Suara – ${kabupaten}${kecamatan ? "," : ""} ${kecamatan}${kelurahan ? "," : ""} ${kelurahan}${
				tps ? "," : ""
			} ${tps}`,
				...
				<CardContent className="grid grid-cols-2 sm:grid-cols-4 gap-4">
					<SelectGroup>
						...
						<Select value={kabupaten} onValueChange={setKabupaten}>
							...
							<SelectContent>
								{["Kab. Contoh 1", "Kab. Contoh 2", "Kab. Contoh 3"].map((val) => (
