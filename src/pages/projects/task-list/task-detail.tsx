	...
	return (
		<>
			<Container>
				...
				<div className="item">
					<div className="label">Nama Program</div>
            ...
            <AvatarImage src={reporter} alt="@shadcn" />
				...
				{/* <div className="item">
          <div className="label">Penanggung Jawab</div>
          <div className="flex gap-2">
            {assignee.map((item) => (
              <Avatar key={item}>
				...
				<div className="item">
					<div className="label">Sasaran</div>
					...
					<Popover>
						<PopoverTrigger asChild>
							<Button variant={"outline"}>
								{date ? dayjs(date).format("DD/MM/YYYY") : <span>Pilih tanggal</span>}
							</Button>
						</PopoverTrigger>
				...
				<div className="item">
					<div className="label">Prioritas</div>
