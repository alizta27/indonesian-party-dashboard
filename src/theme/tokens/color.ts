...
export const presetsColors = {
	...
	[ThemeColorPresets.Orange]: {
		lighter: "#FFF3E0", // Lebih terang dari base, tone lembut
		light: "#FBCB83", // Warna terang (tinted base)
		default: "#F6A529", // Base color yang diberikan
		dark: "#C17F1F", // Versi gelap dari base (lebih solid)
		darker: "#8F5C16", // Lebih dalam lagi, cocok untuk teks di atas base
	},
